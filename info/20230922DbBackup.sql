...
CREATE TABLE `tbldonhang` (
  ...
  `CongThem` float DEFAULT NULL COMMENT 'chieu dai cong them theo song va so lop, cm',
  `Kho` float DEFAULT NULL COMMENT 'cm',
  `DaiCat` float DEFAULT NULL COMMENT 'cm',
  `SLCatTam` int(11) DEFAULT NULL COMMENT 'cm',
  `SoMetCaiDat` float DEFAULT NULL COMMENT 'Don vi (m)',
  `Xa` int(11) DEFAULT NULL,
  `Rong` float DEFAULT NULL COMMENT 'cm',
  `Canh` float DEFAULT NULL COMMENT 'cm',
  `Cao` float NOT NULL COMMENT 'cm',
  `Lang` int(11) DEFAULT NULL,
  `DoSauLan` float DEFAULT NULL COMMENT 'cm',
...
INSERT INTO `tbldonhang` VALUES (3,3,2,'2312','EBC','5',NULL,130,35,450,NULL,1,30,15,20,1,0.44,'Song E 1','Mat E 1','Song B 1','Mat B 1','Song C 1','Mat C 1','WT140',NULL,NULL,NULL,'KH1',0,0,0,'DH1','PO1',NULL,NULL,NULL,'2023-03-21 23:36:53',1,'@@hostname',NULL),(4,4,2,'5555','BC','7',NULL,170,55,1219,NULL,2,37,18.5,45,1,0.5,'Song E 1','Mat E 1','Song B 1','Mat B 1','Song C 1','Mat C 1','WT140',NULL,NULL,NULL,'KH2',0,0,0,'DH2','PO2',NULL,NULL,NULL,'2023-07-10 14:16:29',1,NULL,NULL),(5,5,2,'2312','BC','2',0,180,100,200,200,3,25,12.5,31,2,0.55,'Song E 1','Mat E 1','Song B 1','Mat B 1','Song C 1','Mat C 1','WT140',NULL,NULL,NULL,'KH3',0,0,0,'DH3','PO3',NULL,NULL,NULL,'2023-08-09 06:48:12',1,NULL,NULL),(6,6,2,'5555','BC','5',0,180,50,100,50,4,30,15,15,2,0.2,'Song E 1','Mat E 1','Song B 1','Mat B 1','Song C 1','Mat C 1','WT140',NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,'2023-09-20 11:20:38',1,NULL,NULL),(7,7,1,'2312','BC','2',0,100,40,500,200,1,75,37.5,25,1,0.4,'Song E 1','Mat E 1','Song B 1','Mat B 1','Song C 1','Mat C 1','WT140',NULL,NULL,NULL,'KH5',0,0,0,'DH5','PO5',NULL,NULL,NULL,'2023-09-20 11:24:17',1,NULL,NULL);
...
CREATE TABLE `tbldonhangdangchay` (
  ...
  `CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP,
  `IsActived` int(11) DEFAULT '1',
  `HoanTatCutter` int(11) DEFAULT NULL,
  `HoanTatSpliter` int(11) DEFAULT '0',
  `HoanTatMayMen` int(11) DEFAULT '0',
  `HoanTatSongE` int(11) DEFAULT '0',
  `HoanTatGiayMatE` int(11) DEFAULT '0',
  `HoanTatGiaySongE` int(11) DEFAULT '0',
  `HoanTatSongB` int(11) DEFAULT '0',
  `HoanTatGiayMatB` int(11) DEFAULT '0',
  `HoanTatGiaySongB` int(11) DEFAULT '0',
  `HoanTatSongC` int(11) DEFAULT '0',
  `HoanTatGiayMatC` int(11) DEFAULT '0',
  `HoanTatGiaySongC` int(11) DEFAULT '0',
...
BEGIN
	SELECT _donHang.*
			,_soLop.CongThem
    FROM tbldonhang _donHang
		left join tblsolop _soLop ON _soLop.TenLop = _donHang.SoLop
    WHERE
		_donHang.IsActived = 1
        and _donHang.Status in (0,1)
    ORDER BY _donHang.stt asc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_tblDonHangGetOnProcessBySTT` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_tblDonHangGetOnProcessBySTT`(
	IN
		_stt int
)
BEGIN
...
-- Dump completed on 2023-09-22 11:14:36
