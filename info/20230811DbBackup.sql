...
CREATE TABLE `tbldonhang` (
  ...
  `CongThem` float DEFAULT NULL COMMENT 'chieu dai cong them theo song va so lop',
  `Kho` float DEFAULT NULL,
  `DaiCat` float DEFAULT NULL,
  `SLCatTam` int(11) DEFAULT NULL,
  `SoMetCaiDat` float DEFAULT NULL,
  `Xa` int(11) DEFAULT NULL,
  `Rong` float DEFAULT NULL,
  `Canh` float DEFAULT NULL,
  `Cao` float NOT NULL,
  `Lang` int(11) DEFAULT NULL,
  `DoSauLan` float DEFAULT NULL,
...
INSERT INTO `tbldonhang` VALUES (3,3,0,'2312','EBC','5',NULL,100,35,450,NULL,1,40,20,50,1,1.9,'Song E 1','Mat E 1','Song B 1','Mat B 1','Song C 1','Mat C 1','WT140',NULL,NULL,NULL,'KH1',0,0,0,'DH1','PO1',NULL,NULL,NULL,'2023-03-21 23:36:53',1,'@@hostname',NULL),(4,4,0,'5555','BC','7',NULL,170,55,1219,NULL,2,37,18.5,45,1,1.5,'Song E 1','Mat E 1','Song B 1','Mat B 1','Song C 1','Mat C 1','WT140',NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,'2023-07-10 14:16:29',1,NULL,NULL),(5,5,0,'2312','BC','2',0,180,100,200,200,3,25,12.5,31,2,1.6,'Song E 1','Mat E 1','Song B 1','Mat B 1','Song C 1','Mat C 1','WT140',NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,'2023-08-09 06:48:12',1,NULL,NULL);
...
-- Dump completed on 2023-08-11 14:56:06
