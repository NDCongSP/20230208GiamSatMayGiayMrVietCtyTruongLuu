...
namespace MayMen
{
    public partial class frmMainMayMen : Form
    {
        ...
        public frmMainMayMen()
        {
            InitializeComponent();

            Load += FrmMainMayMen_Load;

        }

        private void FrmMainMayMen_Load(object sender, EventArgs e)
        {
            _t.Interval = 100;
            _t.Enabled = true;
            _t.Tick += (s, o) =>
            {
                ...
                GlobalVariable.InvokeIfRequired(this, () =>
                {
                    ...
                    _labGIayMenHienTai.Text = _donHangDangChay.GiayMen;
                    _labGIayMenKeTiep.Text = _donHangDoiDon.GiayMen;
                });
