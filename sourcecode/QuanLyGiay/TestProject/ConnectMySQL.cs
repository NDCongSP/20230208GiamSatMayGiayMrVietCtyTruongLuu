...
namespace TestProject
{
    public class ConnectMySQL
    {
        ...
        public string ConectionString = "Data Source=localhost;Port=3306;Database=quanlygiay;UID=root;Password=100100; Min Pool Size=0;Max Pool Size=1000;Pooling=true; Connect Timeout=65535;";// "localhost";

        #region Constructors

        public ConnectMySQL()
        {
            //conn = new MySqlConnection("datasource=" + IpServer + ";database=quanlykho;port=3306;username=root;password=100100;charset=utf8");
        }
